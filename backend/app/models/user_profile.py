...
class UserProfile(Base):
    ...
    education_level = Column(String(50), comment='教育水平')
    ...
    work_years = Column(Integer, comment='工作年限(与experience_years同步)')
    ...
    learning_ability = Column(JSON, comment='学习能力评估结果')
    ...
    learning_style = Column(JSON, comment='学习风格')
    growth_potential = Column(JSON, comment='发展潜力评估结果')
